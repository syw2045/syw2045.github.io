...
![alt text](../../../assets/images/Study/Paper/23/image.png)
...
고차원의 open-world 환경에서 시각적 RL agent를 학습하는 것은 어려움이 있다. 현재 다양한 model-based method를 통해 상호작용 가능한 world model에서 학습해 샘플 효율성을 올렸지만 이러한 agent들은 short snippets of imagined experiences을 기반으로 학습해 근시안적이다.
...
![](<../../../assets/images/Study/Paper/23/image 2.png>)
...
핵심 아이디어는 agent의 attention을 task와 관련된 시각적 관찰 영역으로 유도하여 탐색 효율을 높이는 것이다.
...
![](<../../../assets/images/Study/Paper/23/image 4.png>)
...
![](<../../../assets/images/Study/Paper/23/image 16.png>)
...
![](<../../../assets/images/Study/Paper/23/image 18.png>)

long short-term imaginations을 보면서 affordance map도 확인할 수 있다. 아마 앞의 예시와 마찬가지로 나무를 자르라는 예시로 진행한 것 같다.

## 4.2 MODEL ANALYSES

![](<../../../assets/images/Study/Paper/23/image 19.png>)

Ablation studies를 진행했을 때 intrinsic reward가 중요한 역할을 하고 있는 것을 확인할 수 있다.

# 6. CONCLUSIONS AND LIMITATIONS

이 논문은 고차원의 open-world 환경에서 시각적 RL agent를 훈련할 때 발생하는 어려움을 해결하기 위한 새로운 방식인 LS-Imagine을 제안한다.
